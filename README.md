...
| `character.html` | Night'Flyn's character dashboard: a narrative character read in acts — snapshot/profile, recent-first progression, highscore standouts, milestones/deaths and next actions. The chart, recent 30-day table, projection controls, every tracked highscore category and stable character facts are directly visible; planner shortcuts never recommend off-vocation rows |
